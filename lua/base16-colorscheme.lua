...
function M.setup(colors, config)
    ...
    local darkeradd        = darken(M.colors.base0B, 0.8)
    local darkerchange     = darken(M.colors.base03, 0.8)
    local darkerdelete     = darken(M.colors.base08, 0.8)
    local darkertext       = darken(M.colors.base0D, 0.8)
